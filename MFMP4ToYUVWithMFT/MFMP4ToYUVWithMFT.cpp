...
///
/// Description:
/// This file contains a C++ console application that reads H264 encoded video frames from an mp4 file and decodes
/// them to a YUV pixel format and dumps them to an output file stream.
///
...
/// ffmpeg -vcodec rawvideo -s 640x360 -pix_fmt yuv420p -i rawframes.yuv out.avi
///
/// History:
